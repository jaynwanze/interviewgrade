...
const mockAllCandidates = [
  { id: "c1", full_name: "Alice Anderson", avatar_url: "/images/mock_avatar_f_1.jpg" },
  { id: "c2", full_name: "Bob Brown", avatar_url: "/images/mock_avatar_m_2.jpg" },
  { id: "c3", full_name: "Charlie Davis", avatar_url: "/images/mock_avatar_m_3.jpg" },
  { id: "c4", full_name: "Diana Evans", avatar_url: "/images/mock_avatar_f_4.jpg" },
]
...
export default function MessagesPage() {
  ...
  function createConversation(candidateId: string) {
    ...
    const existing = conversations.find((conv) => conv.candidateId === candidateId)
    if (existing) {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="mt-1 text-[11px] text-muted-foreground">
                      {isYou ? "You" : activeConversation.candidateName} &middot; {timeStr}
                    </span>
                  </div>
                )
              })}
