...
import { EvaluationScores, Interview, InterviewAnswer, InterviewEvaluation, QuestionAnswerFeedback } from '@/types';
...
export const InterviewHistoryDetails = ({
  ...
  if (interview.status === 'not_started') {
    return <div className="text-center p-4">Interview has not started yet.</div>;
  }
             ...
             <div className="text-center">
               ...
               <section className="mb-6">
                 ...
                 <ul className="list-disc list-inside">
                   {evaluation.evaluation_scores.map((score: EvaluationScores) => (
