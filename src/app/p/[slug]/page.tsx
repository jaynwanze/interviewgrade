          ...
          <aside className="lg:sticky lg:top-8">
            <Card className="shadow-md">
              <CardHeader>
                ...
                <CardDescription>
                  Start as a guest. Your name and email are optional.
                </CardDescription>
              </CardHeader>
              <CardContent>
                {detailsError && (
                ...
                <form action={startAction} className="space-y-4">
                  ...
                  <p className="text-center text-xs leading-5 text-muted-foreground">
                    Your session is pinned to this published version, so the
                    questions cannot change underneath you after you start.
                  </p>
                </form>
              </CardContent>
            </Card>
