...
--
-- Name: template_questions: Candidates can views system defined and their own interview questions; Type: POLICY; Schema: public; Owner: supabase_admin
--
...
CREATE POLICY "users_can_manage_own_template_questions_insert" ON "public"."template_questions" FOR
INSERT
TO "authenticated"
WITH CHECK (
    EXISTS (
...
CREATE POLICY "users_can_manage_own_template_questions_update" ON "public"."template_questions" FOR
UPDATE
TO "authenticated"
USING (
    EXISTS (
...
CREATE POLICY "users_can_manage_own_template_questions_delete" ON "public"."template_questions" FOR
DELETE
TO "authenticated"
USING (
    EXISTS (
...
--
-- Name: questions: Users can view system defined and own questions; Type: POLICY; Schema: public; Owner: supabase_admin
--
...
-- Name: jobs Only users can insert update and delete their own jobs; Type: POLICY; Schema: public; Owner: supabase_admin

CREATE POLICY "users_can_manage_own_jobs_insert" ON "public"."jobs" FOR
INSERT
TO "authenticated"
WITH CHECK (
    is_system_defined = FALSE AND "user_id" = "auth"."uid"()
...
CREATE POLICY "users_can_manage_own_jobs_update" ON "public"."jobs" FOR
UPDATE
TO "authenticated"
USING (
    is_system_defined = FALSE AND "user_id" = "auth"."uid"()
...
CREATE POLICY "users_can_manage_own_jobs_delete" ON "public"."jobs" FOR
DELETE
TO "authenticated"
USING (
    is_system_defined = FALSE AND "user_id" = "auth"."uid"()
...
CREATE POLICY "users_can_manage_own_skills_insert" ON "public"."skills" FOR
INSERT
TO "authenticated"
WITH CHECK (
    is_system_defined = FALSE AND "user_id" = "auth"."uid"()
...
CREATE POLICY "users_can_manage_own_skills_update" ON "public"."skills" FOR
UPDATE
TO "authenticated"
USING (
    is_system_defined = FALSE AND "user_id" = "auth"."uid"()
...
CREATE POLICY "users_can_manage_own_skills_delete" ON "public"."skills" FOR
DELETE
TO "authenticated"
USING (
    is_system_defined = FALSE AND "user_id" = "auth"."uid"()
...
CREATE POLICY "users_can_manage_own_job_skills_insert" ON "public"."job_skills" FOR
INSERT
TO "authenticated"
WITH CHECK (
    EXISTS (
...
CREATE POLICY "users_can_manage_own_job_skills_update" ON "public"."job_skills" FOR
UPDATE
TO "authenticated"
USING (
    EXISTS (
...
CREATE POLICY "users_can_manage_own_job_skills_delete" ON "public"."job_skills" FOR
DELETE
TO "authenticated"
USING (
    EXISTS (
